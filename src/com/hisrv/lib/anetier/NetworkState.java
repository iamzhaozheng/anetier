...
public class NetworkState {
	...
	// 电信,移动,联通,wifi 等net网络 //add by lijing24:包含EDGE.CMNET的2G网络和3G及Wifi
	...
	/**
	 * 获取网络类型，是正常网络还是wap网络，copy from 魔图
	 * @param cx
	 * @return
	 */
	private static int checkNetworkType(Context cx) {
		try {
	...
	/**
	 * 判断当前网络时候为2G、3G或者Wifi状态
	 * @param cx
	 * @return
	 */
	public static boolean is2G3GorWifi(Context cx){
